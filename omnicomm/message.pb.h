...
class RecReg_General : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_iddrv(::std::string* iddrv);
...
class RecReg : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_general(::RecReg_General* general);
  ...
  inline void set_allocated_photo(::RecReg_Photo* photo);
  ...
  inline void set_allocated_nav(::RecReg_NAV* nav);
  ...
  inline void set_allocated_unidt(::RecReg_UniDt* unidt);
  ...
  inline void set_allocated_candt(::RecReg_CanDt* candt);
  ...
  inline void set_allocated_llsdt(::RecReg_LLSDt* llsdt);
  ...
  inline void set_allocated_log(::RecReg_LOG* log);
...
inline void RecReg_General::set_allocated_iddrv(::std::string* iddrv) {
  if (iddrv_ != &::google::protobuf::internal::kEmptyString) {
    delete iddrv_;
  }
  if (iddrv) {
...
inline void RecReg_General::set_allocated_phone(::std::string* phone) {
  if (phone_ != &::google::protobuf::internal::kEmptyString) {
    delete phone_;
  }
  if (phone) {
...
inline void RecReg_Photo::set_allocated_buf(::std::string* buf) {
  if (buf_ != &::google::protobuf::internal::kEmptyString) {
    delete buf_;
  }
  if (buf) {
...
inline void RecReg::set_allocated_general(::RecReg_General* general) {
  delete general_;
  general_ = general;
  if (general) {
    set_has_general();
...
inline void RecReg::set_allocated_photo(::RecReg_Photo* photo) {
  delete photo_;
  photo_ = photo;
  if (photo) {
    set_has_photo();
...
inline void RecReg::set_allocated_nav(::RecReg_NAV* nav) {
  delete nav_;
  nav_ = nav;
  if (nav) {
    set_has_nav();
...
inline void RecReg::set_allocated_unidt(::RecReg_UniDt* unidt) {
  delete unidt_;
  unidt_ = unidt;
  if (unidt) {
    set_has_unidt();
...
inline void RecReg::set_allocated_candt(::RecReg_CanDt* candt) {
  delete candt_;
  candt_ = candt;
  if (candt) {
    set_has_candt();
...
inline void RecReg::set_allocated_llsdt(::RecReg_LLSDt* llsdt) {
  delete llsdt_;
  llsdt_ = llsdt;
  if (llsdt) {
    set_has_llsdt();
...
inline void RecReg::set_allocated_log(::RecReg_LOG* log) {
  delete log_;
  log_ = log;
  if (log) {
    set_has_log();
